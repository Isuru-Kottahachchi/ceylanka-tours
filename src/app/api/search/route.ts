...
const searchVariations: { [key: string]: string[] } = {
  ...
  "kanneliya": ["kanneliya", "kanneliya forest reserve", "kanneliya rainforest"],
...
const destinations: Destination[] = [
  ...
  {
    id: 15,
    name: "Pre Historic Caves in Sri Lanka",
    location: "Sabaragamuwa Province",
    path: "/archaeological-prehistoric-sites-in-sri-lanka",
  ...
  },
  {
    ...
    path: "kanneliya",
    image: "/Kanneliya.jpg",
    description: "Biodiversity hotspot and rainforest reserve with hiking trails and diverse flora and fauna  ",
    highlights: ["Rainforest Reserve", "Hiking Trails", "Diverse Flora and Fauna", "Bird Watching", "Waterfalls"],
    category: "Nature",
  },
  {
    id: 42,
