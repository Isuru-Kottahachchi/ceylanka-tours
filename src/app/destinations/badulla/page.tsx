    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl md:max-w-6xl mx-auto">
          <h1 className="hero-text-shadow text-4xl md:text-6xl font-extrabold mb-4 leading-[1.1] tracking-tight">Badulla</h1>
                  ...
                  <div>
                    ...
                    <div data-promo="true" className="mt-3 p-3 bg-orange-100 dark:bg-slate-700 rounded-md border-l-4 border-orange-500 dark:border-orange-400">
                      <p className="text-xs text-orange-800 dark:text-orange-200 mb-2">
                        <strong>🌟 Recommended:</strong> <span className="font-semibold"> Ceylanka tours</span> offers reliable, comfortable vehicles with experienced drivers who know the best routes to Badulla. Professional service, fair pricing, and excellent local knowledge make them a top choice for hassle-free travel.
                      </p>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h3 className="text-3xl md:text-4xl font-extrabold tracking-tight">Gale Pansala (Stone Temple)</h3>
                </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h3 className="text-3xl md:text-4xl font-extrabold tracking-tight">Muthiyangana Raja Maha Vihara</h3>
                </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h3 className="text-3xl md:text-4xl font-extrabold tracking-tight">Dunhinda Falls</h3>
                </div>
            ...
            <Card>
              <CardHeader>
                <div className="flex items-center gap-4 mb-2">
                  ...
                  <h3 className="text-3xl md:text-4xl font-extrabold tracking-tight">Badulla Railway Station</h3>
                </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center mb-8">
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-2 italic">
                Tea plantations surrounding Badulla offer authentic Ceylon tea experiences (PC- Martina Bendetto)
              </p>
            </div>
