...
import { Clock, MapPin, CheckCircle, Star, Calendar, Users, TreePine, Bird } from "lucide-react"
            ...
            <div className="max-w-6xl mx-auto px-4 py-12">
                            ...
                            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                                ...
                                <Card className="border-l-4 border-blue-600">
                                    <CardContent className="p-4">
                                        <Image
                                            src="/Sri-Lanka-Blue-Magpie.jpg"
                                            alt="Beautiful Sri Lanka Blue Magpie with brilliant blue plumage and long tail in forest canopy"
                                            width={300}
                                            height={200}
                                            className="rounded-lg mb-3 w-full object-contain bg-gray-50 h-40"
                                        />
                                        <div className="flex items-center gap-3 mb-3">
                                            <div className="text-2xl">🪶</div>
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <h4 className="font-semibold text-blue-700">Sri Lanka Blue Magpie</h4>
                                                    <Badge className="bg-red-100 text-red-700 border-red-300 text-xs px-2 py-1">ENDEMIC</Badge>
                                                </div>
                                                <p className="text-xs text-muted-foreground">Urocissa ornata</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="text-xs space-y-1">
                                            ...
                                            <p><strong>Behavior:</strong> Moves in small flocks, very vocal</p>
                                            <p><strong>Status:</strong> Endemic to Sri Lanka</p>
                                        </div>
                                    </CardContent>
                                </Card>
                                ...
                                <Card className="border-l-4 border-orange-600">
                                    <CardContent className="p-4">
                                        <Image
                                            src="/Jungle-fowl.jpg"
                                            alt="Colorful Sri Lankan Junglefowl male with distinctive red and orange plumage in natural habitat"
                                            width={300}
                                            height={200}
                                            className="rounded-lg mb-3 w-full object-contain bg-gray-50 h-40"
                                        />
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <h4 className="font-semibold text-orange-700">Sri Lankan Junglefowl</h4>
                                                    <Badge className="bg-red-100 text-red-700 border-red-300 text-xs px-2 py-1">ENDEMIC</Badge>
                                                </div>
                                                <p className="text-xs text-muted-foreground">Gallus lafayettii</p>
                                            </div>
                                        </div>
                                        <p className="text-sm text-muted-foreground mb-2">
                                        ...
                                        <div className="text-xs space-y-1">
                                            ...
                                            <p><strong>Behavior:</strong> Ground forager, loud crowing calls</p>
                                            <p><strong>Status:</strong> National bird of Sri Lanka</p>
                                        </div>
                                    </CardContent>
                                </Card>

                                {/* Ceylon Magpie-Robin - Endemic */}
                                <Card className="border-l-4 border-purple-600">
                                    <CardContent className="p-4">
                                        <Image
                                            src="/Sri-Lankan-Grey-hornbill.jpg"
                                            alt="Ceylon Magpie-Robin perched on branch showing black and white plumage pattern"
                                            width={300}
                                            height={200}
                                            className="rounded-lg mb-3 w-full object-contain bg-gray-50 h-40"
                                        />
                                        <div className="flex items-center gap-3 mb-3">
                                            ...
                                            <div className="flex-1">
                                                <div className="flex items-center gap-2 mb-1">
                                                    <h4 className="font-semibold text-purple-700">Sri Lankan Grey hornbill</h4>
                                                    <Badge className="bg-red-100 text-red-700 border-red-300 text-xs px-2 py-1">ENDEMIC</Badge>
                                                </div>
                                                <p className="text-xs text-muted-foreground">Ocyceros gingalensis</p>
                                            </div>
                                        </div>
                                        <p className="text-sm text-muted-foreground mb-2">
                                            Medium-sized hornbill with grey plumage and distinctive casque on bill. Found only in Sri Lanka&apos;s dry zone forests, often seen calling from treetops.
                                        </p>
                                        <div className="text-xs space-y-1">
                                            <p><strong>Best Time:</strong> Early morning and late afternoon</p>
                                ...
                                <Card className="border-l-4 border-cyan-400">
                                    <CardContent className="p-4">
                                        <Image
                                            src="/White-breasted-kingfisher.jpg"
                ...
                <section className="mb-12">
                    ...
                    <p className="text-lg text-muted-foreground mb-8 text-center max-w-3xl mx-auto">
                        Extend your Kumana adventure with these incredible destinations within easy reach
                    </p>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        <Card className="transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                            <div className="relative h-48">
                                ...
                                <div className="absolute top-2 right-2 bg-blue-600 text-white text-xs px-2 py-1 rounded">
                                    12 mins from Kumana National Park
                                </div>
                            </div>
                            <CardContent className="p-4">
                                <h3 className="font-bold text-lg mb-2">Lahugala Kitulana National Park</h3>
                                ...
                                <div className="flex items-center text-xs text-blue-600 mb-2">
                                    ...
                                    12 Km from Kumana National Park
                                </div>
                        ...
                        <Card className="transform transition-transform duration-300 hover:scale-105 hover:shadow-xl">
                            <div className="relative h-48">
                                <Image
                                    src="/Arugam-bay.jpeg"
                                    alt="Arugam Bay with surf and beach activities"
                                    fill
                                    className="object-cover rounded-t-lg"
                                />
                                <div className="absolute top-2 right-2 bg-blue-600 text-white text-xs px-2 py-1 rounded">
                            ...
                            <CardContent className="p-4">
                                <h3 className="font-bold text-lg mb-2">Arugam Bay</h3>
                                <p className="text-sm text-muted-foreground mb-3">
                                ...
                                <div className="flex items-center text-xs text-blue-600 mb-2">
                                    <MapPin className="w-3 h-3 mr-1" />
                                    56 km from Kumana National Park
                                </div>
                                <div className="mt-4 flex justify-start">
