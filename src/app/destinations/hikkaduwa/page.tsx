...
import { Clock, CheckCircle, Waves, Fish, Camera, ChevronLeft, ChevronRight, MapPin, Sun, Users, Star } from "lucide-react"
    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative h-[65vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-6xl mx-auto">
          <h1 className="hero-text-shadow text-4xl md:text-6xl font-extrabold mb-4 leading-[1.1] tracking-tight">Hikkaduwa</h1>
            ...
            <Card>
              <CardHeader>
                <CardTitle className="flex items-center gap-2">
                  ...
                  Quick Facts About Hikkaduwa Beach
                </CardTitle>
              </CardHeader>
              <CardContent>
