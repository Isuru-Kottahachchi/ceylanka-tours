    ...
    <main className="min-h-screen bg-background">
      ...
      <section className="relative h-[50vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-4xl mx-auto">
          <h1 className="hero-text-shadow text-4xl md:text-6xl font-extrabold mb-4 leading-[1.1] tracking-tight">Balangoda</h1>
                ...
                <div className="grid md:grid-cols-2 gap-6 items-center">
                  ...
                  <div>
                    ...
                    <div className="mt-4 flex justify-start">
                      <Link href="/destinations/archaeological-prehistoric-sites-in-sri-lanka" passHref legacyBehavior>
                        <Button
                          variant="secondary"
