    ...
    <main className="bg-white text-gray-800">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        ...
        <section className="mb-12">
          ...
          <div className="mb-10 bg-white rounded-lg shadow-md p-6 border border-gray-200">
        ...
        <section className="mb-12 bg-gradient-to-br from-gray-50 to-white p-8 rounded-lg shadow-md border border-gray-200">
          <h2 className="text-3xl font-bold text-gray-900 mb-6">Parts of a Stupa</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="bg-white p-5 rounded-lg border border-gray-200">
              <h3 className="font-bold text-lg text-gray-900 mb-2">🔵 Pesa Valalu (Base Platforms)</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div className="bg-white p-5 rounded-lg border border-gray-200">
              <h3 className="font-bold text-lg text-gray-900 mb-2">🔵 Garbhaya (Relic Chamber)</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div className="bg-white p-5 rounded-lg border border-gray-200">
              <h3 className="font-bold text-lg text-gray-900 mb-2">🔵 Anda or Garbha (The Dome)</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div className="bg-white p-5 rounded-lg border border-gray-200">
              <h3 className="font-bold text-lg text-gray-900 mb-2">🔵 Hatharas Kotuwa (Square Terrace)</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div className="bg-white p-5 rounded-lg border border-gray-200">
              <h3 className="font-bold text-lg text-gray-900 mb-2">🔵 Devata Kotuwa (Crown)</h3>
              <p className="text-gray-700 text-sm">
            ...
            <div className="bg-white p-5 rounded-lg border border-gray-200">
              <h3 className="font-bold text-lg text-gray-900 mb-2">🔵 Kotha (Pinnacle)</h3>
              <p className="text-gray-700 text-sm">
