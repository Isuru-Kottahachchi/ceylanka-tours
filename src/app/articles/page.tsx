...
const originalArticles = [
  ...
  // },
    {
    id: 16,
    title: "Mystrious places in Sri Lanka",
    path: "mysterious-places-in-sri-lanka",
    category: "Architecture",
    readTime: "9 min read",
    image: "/Mystrious-places-in-Sri-Lanka.png",
    description: "Discover the unique architectural elements and symbolic meanings of traditional Sri Lankan door designs and craftsmanship.",
    highlights: ["Danigala", "Universal Doors", "Cultural Symbols"],
    featured: false,
  },
  {
    id: 17,
