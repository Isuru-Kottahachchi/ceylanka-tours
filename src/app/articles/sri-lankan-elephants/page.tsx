    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="max-w-6xl mx-auto px-4 py-12">
        ...
        <nav className="flex items-center space-x-2 text-sm text-muted-foreground mb-8">
          ...
          <span>/</span>
          <span className="text-foreground">Sri Lankan Elephants</span>
        </nav>
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <p className="text-muted-foreground mb-4 leading-relaxed">Asian Elephants have a few subspecies like <b>Sri Lankan elephant (Elephas maximus maximus)</b>, <b>Indian Elephant (Elephas maximus indicus)</b>, and <b>Sumatran Elephant (Elephas maximus sumatranus)</b>.</p><br />
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-4">
                  <div className="border-l-4 border-blue-500 pl-4">
                    <h3 className="font-semibold text-foreground mb-2">Baby Elephant (0-2 years)</h3>
                  ...
                  <div className="border-l-4 border-green-500 pl-4">
                    <h3 className="font-semibold text-foreground mb-2">Young Elephant (2-15 years)</h3>
                    <p className="text-muted-foreground">
                  ...
                  <div className="border-l-4 border-orange-500 pl-4">
                    <h3 className="font-semibold text-foreground mb-2">Adult Elephant (15-50 years)</h3>
                    <p className="text-muted-foreground">
                  ...
                  <div className="border-l-4 border-purple-500 pl-4">
                    <h3 className="font-semibold text-foreground mb-2">Old Elephant (50+ years)</h3>
                    <p className="text-muted-foreground">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">Amazing Elephant Facts:</h3>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start space-x-2">
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">Diet and Feeding:</h3>
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">Important Places in Sri Lanka:</h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="p-4 bg-muted rounded-lg">
                    <h4 className="font-semibold text-foreground mb-2">Kaudulla National Park</h4>
                    <p className="text-muted-foreground text-sm">One of the best places to see wild elephants in Sri Lanka</p>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    <h4 className="font-semibold text-foreground mb-2">Udawalawe National Park</h4>
                    <p className="text-muted-foreground text-sm">Famous for large elephant herds</p>
                  </div>
                  <div className="p-4 bg-muted rounded-lg">
                    <h4 className="font-semibold text-foreground mb-2">Minneriya National Park</h4>
                    <p className="text-muted-foreground text-sm">Home to &quot;The Gathering&quot; - hundreds of elephants</p>
                  </div>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">Why Elephants Are In Danger:</h3>
                <ul className="space-y-3 text-muted-foreground mb-6">
                  <li className="flex items-start space-x-2">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">How We Can Help:</h3>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start space-x-2">
                    <span className="text-green-600 dark:text-green-400 mt-1">•</span>
            ...
            <Card>
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-4">Cultural Importance:</h3>
                <ul className="space-y-3 text-muted-foreground">
                  <li className="flex items-start space-x-2">
