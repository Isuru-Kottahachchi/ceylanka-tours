    ...
    <section className="py-16 theme-surface">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold theme-text mb-4">Featured Stories</h2>
          ...
          {featuredArticles.map((article) => (
            <Card key={article.id} className="group hover:shadow-lg transition-shadow duration-300 overflow-hidden">
              ...
              <CardContent className="pt-0">
                <p className="theme-text-muted text-sm line-clamp-3 mb-4">{article.excerpt}</p>
